...
def dataset_builder(pathDirData, mode = 'Train'):
    ...
    if(mode == 'Train'):
        ...
        # randomize = np.arange(len(ID))
        # np.random.shuffle(randomize)
        # X_names = X_names[randomize]
        # y = y[randomize]
        # ID = ID[randomize]
        # org = org[randomize]

        # # Shuffling the  validation data
        # randomize = np.arange(len(ID_val))
        # np.random.shuffle(randomize)
        # X_val_names = X_val_names[randomize]
        # y_val = y_val[randomize]
        # ID_val = ID_val[randomize]
        # org_val = org_val[randomize]
        ...
        #         X_val_names = X_val_names,
        #         y_val = y_val,
        #         ID_val = ID_val,
        #         org_val = org_val)

        data = np.load(pathDirData + 'Train_data.npz') 
        X_names = data['X_names']
        y = data['y']
        ID = data['ID']
        org = data['org']

        data = np.load(pathDirData + 'Val_data.npz') 
        X_val_names = data['X_val_names']
        y_val = data['y_val']
        ID_val = data['ID_val']
        org_val = data['org_val']

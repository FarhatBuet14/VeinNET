# -*- coding: utf-8 -*-
"""
Created on Tue Jun  4 22:49:42 2019
...
datafile = "./Troughs_Model/model_AccuEdges/9/data_with_aug.npz"

weightFile = './Troughs_Model/model_AccuEdges/9/WeightFile_best.hdf5'

prediction_fldr = './Troughs_Model/model_AccuEdges/9/prediction/'

cropped_fldr = './Troughs_Model/model_AccuEdges/8/prediction/Cropped/'
...
#        top_right_ = keypoints_rotated[1]
#        
#        width = abs(top_left_[0] - top_right_[0])
#        height = 2 * width
#        if(test_names[sample] == 'p14_left_act_3.bmp'): widths.append(width)
#
#        bottom_right = np.zeros((2, )).astype(int)
#        bottom_right[0] = top_left_[0] + 50
#        bottom_right[1] = top_left_[1] + 90
#        
#        top_left_ = tuple(top_left_.reshape(1, -1)[0])
#        bottom_right = tuple(bottom_right.reshape(1, -1)[0])
#        
#        center = np.zeros((2, )).astype(int)
#        center[0] = top_left_[0] + 25
#        center[1] = top_left_[1] + 45
#        center = tuple(center.reshape(1, -1)[0])
#        
#        crop = cv2.getRectSubPix(image_rotated, (50, 90), center)
#        
...
#        image_rotated = cv2.rectangle(image_rotated, top_left_, bottom_right , (0,0,0), 2)
#        

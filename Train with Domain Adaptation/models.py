...
class resnet50_DANN(torch.nn.Module):
    ...
    def __init__(self, opt):
        ...
        self.roi_model.add_module('c_fc1', nn.Linear(2048, 1024))
        self.roi_model.add_module('c_bn1', nn.BatchNorm1d(1024))
        self.roi_model.add_module('c_relu1', nn.ReLU(True))
        self.roi_model.add_module('c_fc2', nn.Linear(1024, 256))
        self.roi_model.add_module('c_bn2', nn.BatchNorm1d(256))
        self.roi_model.add_module('c_relu2', nn.ReLU(True))
        self.roi_model.add_module('c_fc3', nn.Linear(256, opt.nnClassCount))
        self.roi_model.add_module('c_relu3', nn.ReLU(True))
